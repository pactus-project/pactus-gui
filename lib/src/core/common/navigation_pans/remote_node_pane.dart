        ...
        return NavigationView(
          pane: NavigationPane(
            ...
            onChanged: (index) {
              ...
              final canGoBack = index == selectedIndex - 1 && selectedIndex < 1 && navigationCubit.canGoBack();

              // If you've reached the first page, you won't be able to go back
              if (selectedIndex == 1) {
                // If you've reached the first page, going backward is not allowed
                if (index == selectedIndex - 1) return;
              }
