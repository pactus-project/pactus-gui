...
class CodegenLoader {
  ...
  static const Map<String, dynamic> frFR = {
    ...
    'restore_local_node_from_seed_pharse':
        'Restaurer le nœud local à partir de la phrase de graine',
    ...
    'generation_seed_description':
        'Initiez votre voyage cryptographique avec confiance',
  ...
  static const Map<String, dynamic> esES = {
    ...
    'welcome_description':
        'Donde el futuro de blockchain se desarrolla con confianza y transparencia en cada transacción. ¡Únete a nosotros para dar forma a una revolución descentralizada!',
