...
class CodegenLoader {
  ...
  static const Map<String, dynamic> frFR = {
    ...
    'your_journey_finalized_description':
        'Saventurant dans le domaine de la technologie blockchain, Pactus annonce une ère de décentralisation sans compromis qui contraste avec ses contemporains. Il rejette les hiérarchies de pouvoir traditionnelles, se séparant des systèmes de preuve denjeu déléguée et des opérations minières qui pourraient conduire à une concentration de pouvoir. Ce faisant, Pactus abaisse ses remparts, invitant les participants de tous horizons à se joindre comme égaux dans le maintien du réseau. Dans cette tapisserie communautaire, chaque utilisateur a lopportunité dagir comme un client validateur, contribuant à linvulnérabilité du réseau au contrôle ou à la censure, assurant lintégrité et lautonomie de la plateforme.',
    'your_journey_finalized_description_last':
        'Pactus ne révolutionne pas seulement la structure de la gouvernance blockchain; il redéfinit également lexpérience utilisateur. Conçu avec la conviction que la blockchain devrait être accessible à tous, la chaîne Pactus dispose dune interface graphique utilisateur (GUI) simple mais sophistiquée qui démystifie le processus dexécution dun nœud. Lélégance réside dans sa simplicité - un design clair et accessible qui dissimule les mécanismes robustes et complexes en dessous, permettant aux utilisateurs, quel que soit leur savoir-faire technique, de participer en tant que clients validateurs. Ce mouvement vers linclusivité transforme les utilisateurs de simples participants en gardiens de la blockchain, une facette essentielle de lécosystème Pactus.',
