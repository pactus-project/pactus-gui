...
class CodegenLoader {
  ...
  static const Map<String, dynamic> enUS = {
    ...
    'error_grpc_cancelled': 'Request was cancelled',
    'error_grpc_unauthenticated': 'You are not authenticated',
    ...
    'validator': 'Validator',
    'addNote': 'Add a note...',
    'retryGettingData': 'Retry to getting Data',
    'memo': 'Memo',
  ...
  static const Map<String, dynamic> frFR = {
    ...
    'error_no_internet': 'Pas de connexion Internet ou serveur inaccessible',
    'error_timeout': 'Délai d`attente dépassé, veuillez réessayer',
    'error_unexpected': 'Erreur inattendue',
    'error_grpc_cancelled': 'La requête a été annulée',
    'error_grpc_unauthenticated': 'Vous n`êtes pas authentifié',
    ...
    'retryGettingData': 'Réessayer d\'obtenir les données',
    'memo': 'Mémo',
    'selectValidator': 'Sélectionner le Validateur',
  ...
  static const Map<String, dynamic> esES = {
    ...
    'error_no_internet': 'Sin conexión a internet o servidor inalcanzable',
    'error_timeout': 'Tiempo de espera agotado, por favor intente nuevamente',
    'error_unexpected': 'Error inesperado',
    'error_grpc_cancelled': 'La solicitud fue cancelada',
    'error_grpc_unauthenticated': 'No estás autenticado',
    ...
    'retryGettingData': 'Reintentar obtener datos',
    'memo': 'Memo',
