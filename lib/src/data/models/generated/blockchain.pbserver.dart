...
abstract class BlockchainServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      ...
      case 'GetBlockHash':
        return this.getBlockHash(ctx, request as $1.GetBlockHashRequest);
      case 'GetBlockHeight':
        return this.getBlockHeight(ctx, request as $1.GetBlockHeightRequest);
      case 'GetBlockchainInfo':
        return this
            .getBlockchainInfo(ctx, request as $1.GetBlockchainInfoRequest);
      case 'GetConsensusInfo':
        return this
            .getConsensusInfo(ctx, request as $1.GetConsensusInfoRequest);
      case 'GetAccount':
        return this.getAccount(ctx, request as $1.GetAccountRequest);
      case 'GetValidator':
        return this.getValidator(ctx, request as $1.GetValidatorRequest);
      case 'GetValidatorByNumber':
        return this.getValidatorByNumber(
            ctx, request as $1.GetValidatorByNumberRequest);
      case 'GetValidatorAddresses':
        return this.getValidatorAddresses(
            ctx, request as $1.GetValidatorAddressesRequest);
      case 'GetPublicKey':
        return this.getPublicKey(ctx, request as $1.GetPublicKeyRequest);
      case 'GetTxPoolContent':
        return this
            .getTxPoolContent(ctx, request as $1.GetTxPoolContentRequest);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
