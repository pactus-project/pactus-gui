...
final $typed_data.Uint8List getNetworkInfoRequestDescriptor = $convert.base64Decode(
    'ChVHZXROZXR3b3JrSW5mb1JlcXVlc3QSJQoOb25seV9jb25uZWN0ZWQYASABKAhSDW9ubHlDb25uZWN0ZWQ=');
...
final $typed_data.Uint8List getNetworkInfoResponseDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List getNodeInfoResponseDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List zMQPublisherInfoDescriptor = $convert.base64Decode(
    'ChBaTVFQdWJsaXNoZXJJbmZvEhQKBXRvcGljGAEgASgJUgV0b3BpYxIYCgdhZGRyZXNzGAIgASgJUgdhZGRyZXNzEhAKA2h3bRgDIAEoBVIDaHdt');
...
final $typed_data.Uint8List peerInfoDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List connectionInfoDescriptor = $convert.base64Decode(
    'Cg5Db25uZWN0aW9uSW5mbxIgCgtjb25uZWN0aW9ucxgBIAEoBFILY29ubmVjdGlvbnMSLwoTaW5ib3VuZF9jb25uZWN0aW9ucxgCIAEoBFISaW5ib3VuZENvbm5lY3Rpb25zEjEKFG91dGJvdW5kX2Nvbm5lY3Rpb25zGAMgASgEUhNvdXRib3VuZENvbm5lY3Rpb25z');
...
const MetricInfo$json = const {
  ...
  '3': const [
    MetricInfo_MessageSentEntry$json,
...
final $typed_data.Uint8List metricInfoDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List counterInfoDescriptor = $convert.base64Decode(
    'CgtDb3VudGVySW5mbxIUCgVCeXRlcxgBIAEoBFIFQnl0ZXMSGAoHQnVuZGxlcxgCIAEoBFIHQnVuZGxlcw==');
...
final $typed_data.Uint8List networkServiceDescriptor = $convert.base64Decode(
    'CgdOZXR3b3JrEk8KDkdldE5ldHdvcmtJbmZvEh0ucGFjdHVzLkdldE5ldHdvcmtJbmZvUmVxdWVzdBoeLnBhY3R1cy5HZXROZXR3b3JrSW5mb1Jlc3BvbnNlEkYKC0dldE5vZGVJbmZvEhoucGFjdHVzLkdldE5vZGVJbmZvUmVxdWVzdBobLnBhY3R1cy5HZXROb2RlSW5mb1Jlc3BvbnNl');
