...
class GetNetworkInfoRequest extends $pb.GeneratedMessage {
  ...
  factory GetNetworkInfoRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  GetNetworkInfoRequest clone() =>
      GetNetworkInfoRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
  ...
  GetNetworkInfoRequest copyWith(
      ...
      super.copyWith((message) => updates(message as GetNetworkInfoRequest))
          as GetNetworkInfoRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetNetworkInfoRequest create() => GetNetworkInfoRequest._();
  GetNetworkInfoRequest createEmptyInstance() => create();
  static $pb.PbList<GetNetworkInfoRequest> createRepeated() =>
      $pb.PbList<GetNetworkInfoRequest>();
  @$core.pragma('dart2js:noInline')
...
class GetNetworkInfoResponse extends $pb.GeneratedMessage {
  ...
  factory GetNetworkInfoResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GetNetworkInfoResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  GetNetworkInfoResponse clone() =>
      GetNetworkInfoResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  GetNetworkInfoResponse copyWith(
      ...
      super.copyWith((message) => updates(message as GetNetworkInfoResponse))
          as GetNetworkInfoResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetNetworkInfoResponse create() => GetNetworkInfoResponse._();
  GetNetworkInfoResponse createEmptyInstance() => create();
  static $pb.PbList<GetNetworkInfoResponse> createRepeated() =>
      $pb.PbList<GetNetworkInfoResponse>();
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set connectedPeersCount($core.int v) {
...
class GetNodeInfoResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(5)
  set reachability($core.String v) {
    $_setString(4, v);
  }
  ...
  @$pb.TagNumber(7)
  set servicesNames($core.String v) {
    $_setString(6, v);
  }
  ...
  @$pb.TagNumber(14)
  set connectionInfo(ConnectionInfo v) {
    setField(14, v);
  }
...
class ZMQPublisherInfo extends $pb.GeneratedMessage {
  ...
  factory ZMQPublisherInfo.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ZMQPublisherInfo.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  ZMQPublisherInfo copyWith(void Function(ZMQPublisherInfo) updates) =>
      super.copyWith((message) => updates(message as ZMQPublisherInfo))
          as ZMQPublisherInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ZMQPublisherInfo create() => ZMQPublisherInfo._();
  ZMQPublisherInfo createEmptyInstance() => create();
  static $pb.PbList<ZMQPublisherInfo> createRepeated() =>
      $pb.PbList<ZMQPublisherInfo>();
  @$core.pragma('dart2js:noInline')
...
class PeerInfo extends $pb.GeneratedMessage {
  ...
  factory PeerInfo.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PeerInfo.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  PeerInfo copyWith(void Function(PeerInfo) updates) =>
      super.copyWith((message) => updates(message as PeerInfo))
          as PeerInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(11)
  set lastReceived($fixnum.Int64 v) {
    $_setInt64(10, v);
  }
  ...
  @$pb.TagNumber(16)
  set completedSessions($core.int v) {
...
class ConnectionInfo extends $pb.GeneratedMessage {
  ...
  factory ConnectionInfo.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ConnectionInfo.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  ConnectionInfo copyWith(void Function(ConnectionInfo) updates) =>
      super.copyWith((message) => updates(message as ConnectionInfo))
          as ConnectionInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ConnectionInfo create() => ConnectionInfo._();
  ConnectionInfo createEmptyInstance() => create();
  static $pb.PbList<ConnectionInfo> createRepeated() =>
      $pb.PbList<ConnectionInfo>();
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set connections($fixnum.Int64 v) {
    $_setInt64(0, v);
  }
  ...
  @$pb.TagNumber(2)
  set inboundConnections($fixnum.Int64 v) {
    $_setInt64(1, v);
  }
  ...
  @$pb.TagNumber(3)
  set outboundConnections($fixnum.Int64 v) {
    $_setInt64(2, v);
  }
...
class MetricInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<CounterInfo>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'TotalReceived',
        protoName: 'TotalReceived',
        subBuilder: CounterInfo.create)
    ..m<$core.int, CounterInfo>(
        4,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'MessageSent',
        protoName: 'MessageSent',
  ...
  factory MetricInfo.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory MetricInfo.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  MetricInfo copyWith(void Function(MetricInfo) updates) =>
      super.copyWith((message) => updates(message as MetricInfo))
          as MetricInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set totalInvalid(CounterInfo v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(3)
  set totalReceived(CounterInfo v) {
    setField(3, v);
  }
...
class CounterInfo extends $pb.GeneratedMessage {
  ...
  factory CounterInfo.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CounterInfo.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  CounterInfo copyWith(void Function(CounterInfo) updates) =>
      super.copyWith((message) => updates(message as CounterInfo))
          as CounterInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class NetworkApi {
  ...
  $async.Future<GetNetworkInfoResponse> getNetworkInfo(
    ...
    return _client.invoke<GetNetworkInfoResponse>(
        ctx, 'Network', 'GetNetworkInfo', request, emptyResponse);
  }
  ...
  $async.Future<GetNodeInfoResponse> getNodeInfo(
    ...
    return _client.invoke<GetNodeInfoResponse>(
        ctx, 'Network', 'GetNodeInfo', request, emptyResponse);
  }
}
