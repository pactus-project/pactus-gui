...
final $typed_data.Uint8List addressTypeDescriptor = $convert.base64Decode(
    'CgtBZGRyZXNzVHlwZRIZChVBRERSRVNTX1RZUEVfVFJFQVNVUlkQABIaChZBRERSRVNTX1RZUEVfVkFMSURBVE9SEAESHAoYQUREUkVTU19UWVBFX0JMU19BQ0NPVU5UEAISIAocQUREUkVTU19UWVBFX0VEMjU1MTlfQUNDT1VOVBAD');
...
final $typed_data.Uint8List addressInfoDescriptor = $convert.base64Decode(
    'CgtBZGRyZXNzSW5mbxIYCgdhZGRyZXNzGAEgASgJUgdhZGRyZXNzEh0KCnB1YmxpY19rZXkYAiABKAlSCXB1YmxpY0tleRIUCgVsYWJlbBgDIAEoCVIFbGFiZWwSEgoEcGF0aBgEIAEoCVIEcGF0aA==');
...
final $typed_data.Uint8List historyInfoDescriptor = $convert.base64Decode(
    'CgtIaXN0b3J5SW5mbxIlCg50cmFuc2FjdGlvbl9pZBgBIAEoCVINdHJhbnNhY3Rpb25JZBISCgR0aW1lGAIgASgNUgR0aW1lEiEKDHBheWxvYWRfdHlwZRgDIAEoCVILcGF5bG9hZFR5cGUSIAoLZGVzY3JpcHRpb24YBCABKAlSC2Rlc2NyaXB0aW9uEhYKBmFtb3VudBgFIAEoA1IGYW1vdW50');
...
final $typed_data.Uint8List getAddressHistoryRequestDescriptor =
    $convert.base64Decode(
        'ChhHZXRBZGRyZXNzSGlzdG9yeVJlcXVlc3QSHwoLd2FsbGV0X25hbWUYASABKAlSCndhbGxldE5hbWUSGAoHYWRkcmVzcxgCIAEoCVIHYWRkcmVzcw==');
...
final $typed_data.Uint8List getAddressHistoryResponseDescriptor =
    $convert.base64Decode(
        'ChlHZXRBZGRyZXNzSGlzdG9yeVJlc3BvbnNlEjYKDGhpc3RvcnlfaW5mbxgBIAMoCzITLnBhY3R1cy5IaXN0b3J5SW5mb1ILaGlzdG9yeUluZm8=');
...
final $typed_data.Uint8List getNewAddressRequestDescriptor = $convert.base64Decode(
    'ChRHZXROZXdBZGRyZXNzUmVxdWVzdBIfCgt3YWxsZXRfbmFtZRgBIAEoCVIKd2FsbGV0TmFtZRI2CgxhZGRyZXNzX3R5cGUYAiABKA4yEy5wYWN0dXMuQWRkcmVzc1R5cGVSC2FkZHJlc3NUeXBlEhQKBWxhYmVsGAMgASgJUgVsYWJlbBIaCghwYXNzd29yZBgEIAEoCVIIcGFzc3dvcmQ=');
...
final $typed_data.Uint8List getNewAddressResponseDescriptor = $convert.base64Decode(
    'ChVHZXROZXdBZGRyZXNzUmVzcG9uc2USHwoLd2FsbGV0X25hbWUYASABKAlSCndhbGxldE5hbWUSNgoMYWRkcmVzc19pbmZvGAIgASgLMhMucGFjdHVzLkFkZHJlc3NJbmZvUgthZGRyZXNzSW5mbw==');
...
final $typed_data.Uint8List restoreWalletRequestDescriptor = $convert.base64Decode(
    'ChRSZXN0b3JlV2FsbGV0UmVxdWVzdBIfCgt3YWxsZXRfbmFtZRgBIAEoCVIKd2FsbGV0TmFtZRIaCghtbmVtb25pYxgCIAEoCVIIbW5lbW9uaWMSGgoIcGFzc3dvcmQYAyABKAlSCHBhc3N3b3Jk');
...
final $typed_data.Uint8List restoreWalletResponseDescriptor = $convert.base64Decode(
    'ChVSZXN0b3JlV2FsbGV0UmVzcG9uc2USHwoLd2FsbGV0X25hbWUYASABKAlSCndhbGxldE5hbWU=');
...
final $typed_data.Uint8List createWalletRequestDescriptor = $convert.base64Decode(
    'ChNDcmVhdGVXYWxsZXRSZXF1ZXN0Eh8KC3dhbGxldF9uYW1lGAEgASgJUgp3YWxsZXROYW1lEhoKCHBhc3N3b3JkGAQgASgJUghwYXNzd29yZA==');
...
final $typed_data.Uint8List getValidatorAddressRequestDescriptor =
    $convert.base64Decode(
        'ChpHZXRWYWxpZGF0b3JBZGRyZXNzUmVxdWVzdBIdCgpwdWJsaWNfa2V5GAEgASgJUglwdWJsaWNLZXk=');
...
final $typed_data.Uint8List signRawTransactionRequestDescriptor =
    $convert.base64Decode(
        'ChlTaWduUmF3VHJhbnNhY3Rpb25SZXF1ZXN0Eh8KC3dhbGxldF9uYW1lGAEgASgJUgp3YWxsZXROYW1lEicKD3Jhd190cmFuc2FjdGlvbhgCIAEoCVIOcmF3VHJhbnNhY3Rpb24SGgoIcGFzc3dvcmQYAyABKAlSCHBhc3N3b3Jk');
...
final $typed_data.Uint8List signRawTransactionResponseDescriptor =
    $convert.base64Decode(
        'ChpTaWduUmF3VHJhbnNhY3Rpb25SZXNwb25zZRIlCg50cmFuc2FjdGlvbl9pZBgBIAEoCVINdHJhbnNhY3Rpb25JZBI0ChZzaWduZWRfcmF3X3RyYW5zYWN0aW9uGAIgASgJUhRzaWduZWRSYXdUcmFuc2FjdGlvbg==');
...
final $typed_data.Uint8List getTotalBalanceRequestDescriptor =
    $convert.base64Decode(
        'ChZHZXRUb3RhbEJhbGFuY2VSZXF1ZXN0Eh8KC3dhbGxldF9uYW1lGAEgASgJUgp3YWxsZXROYW1l');
...
final $typed_data.Uint8List getTotalBalanceResponseDescriptor =
    $convert.base64Decode(
        'ChdHZXRUb3RhbEJhbGFuY2VSZXNwb25zZRIfCgt3YWxsZXRfbmFtZRgBIAEoCVIKd2FsbGV0TmFtZRIjCg10b3RhbF9iYWxhbmNlGAIgASgDUgx0b3RhbEJhbGFuY2U=');
...
final $typed_data.Uint8List signMessageRequestDescriptor = $convert.base64Decode(
    'ChJTaWduTWVzc2FnZVJlcXVlc3QSHwoLd2FsbGV0X25hbWUYASABKAlSCndhbGxldE5hbWUSGgoIcGFzc3dvcmQYAiABKAlSCHBhc3N3b3JkEhgKB2FkZHJlc3MYAyABKAlSB2FkZHJlc3MSGAoHbWVzc2FnZRgEIAEoCVIHbWVzc2FnZQ==');
...
final $typed_data.Uint8List getTotalStakeResponseDescriptor = $convert.base64Decode(
    'ChVHZXRUb3RhbFN0YWtlUmVzcG9uc2USHwoLdG90YWxfc3Rha2UYASABKANSCnRvdGFsU3Rha2USHwoLd2FsbGV0X25hbWUYAiABKAlSCndhbGxldE5hbWU=');
...
final $typed_data.Uint8List getAddressInfoRequestDescriptor = $convert.base64Decode(
    'ChVHZXRBZGRyZXNzSW5mb1JlcXVlc3QSHwoLd2FsbGV0X25hbWUYASABKAlSCndhbGxldE5hbWUSGAoHYWRkcmVzcxgCIAEoCVIHYWRkcmVzcw==');
...
final $typed_data.Uint8List getAddressInfoResponseDescriptor =
    $convert.base64Decode(
        'ChZHZXRBZGRyZXNzSW5mb1Jlc3BvbnNlEhgKB2FkZHJlc3MYASABKAlSB2FkZHJlc3MSFAoFbGFiZWwYAiABKAlSBWxhYmVsEh0KCnB1YmxpY19rZXkYAyABKAlSCXB1YmxpY0tleRISCgRwYXRoGAQgASgJUgRwYXRoEh8KC3dhbGxldF9uYW1lGAUgASgJUgp3YWxsZXROYW1l');
...
final $typed_data.Uint8List setLabelRequestDescriptor = $convert.base64Decode(
    'Cg9TZXRMYWJlbFJlcXVlc3QSHwoLd2FsbGV0X25hbWUYASABKAlSCndhbGxldE5hbWUSGgoIcGFzc3dvcmQYAyABKAlSCHBhc3N3b3JkEhgKB2FkZHJlc3MYBCABKAlSB2FkZHJlc3MSFAoFbGFiZWwYBSABKAlSBWxhYmVs');
...
final $typed_data.Uint8List setLabelResponseDescriptor =
    $convert.base64Decode('ChBTZXRMYWJlbFJlc3BvbnNl');
...
final $typed_data.Uint8List getWalletInfoResponseDescriptor = $convert.base64Decode(
    'ChVHZXRXYWxsZXRJbmZvUmVzcG9uc2USHwoLd2FsbGV0X25hbWUYASABKAlSCndhbGxldE5hbWUSGAoHdmVyc2lvbhgCIAEoA1IHdmVyc2lvbhIYCgduZXR3b3JrGAMgASgJUgduZXR3b3JrEhwKCWVuY3J5cHRlZBgEIAEoCFIJZW5jcnlwdGVkEhIKBHV1aWQYBSABKAlSBHV1aWQSHQoKY3JlYXRlZF9hdBgGIAEoA1IJY3JlYXRlZEF0');
...
final $typed_data.Uint8List listAddressResponseDescriptor = $convert.base64Decode(
    'ChNMaXN0QWRkcmVzc1Jlc3BvbnNlEicKBGRhdGEYASADKAsyEy5wYWN0dXMuQWRkcmVzc0luZm9SBGRhdGE=');
const $core.Map<$core.String, $core.dynamic> WalletServiceBase$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'SetAddressLabel',
      '2': '.pactus.SetLabelRequest',
      '3': '.pactus.SetLabelResponse'
    },
    const {
      '1': 'ListWallet',
...
final $typed_data.Uint8List walletServiceDescriptor = $convert.base64Decode(
    '');
