...
final $typed_data.Uint8List payloadTypeDescriptor = $convert.base64Decode(
    'CgtQYXlsb2FkVHlwZRILCgdVTktOT1dOEAASFAoQVFJBTlNGRVJfUEFZTE9BRBABEhAKDEJPTkRfUEFZTE9BRBACEhUKEVNPUlRJVElPTl9QQVlMT0FEEAMSEgoOVU5CT05EX1BBWUxPQUQQBBIUChBXSVRIRFJBV19QQVlMT0FEEAU=');
...
final $typed_data.Uint8List transactionVerbosityDescriptor = $convert.base64Decode(
    'ChRUcmFuc2FjdGlvblZlcmJvc2l0eRIUChBUUkFOU0FDVElPTl9EQVRBEAASFAoQVFJBTlNBQ1RJT05fSU5GTxAB');
...
final $typed_data.Uint8List getTransactionRequestDescriptor = $convert.base64Decode(
    'ChVHZXRUcmFuc2FjdGlvblJlcXVlc3QSDgoCaWQYASABKAlSAmlkEjoKCXZlcmJvc2l0eRgCIAEoDjIcLnBhY3R1cy5UcmFuc2FjdGlvblZlcmJvc2l0eVIJdmVyYm9zaXR5');
...
final $typed_data.Uint8List getTransactionResponseDescriptor =
    $convert.base64Decode(
        'ChZHZXRUcmFuc2FjdGlvblJlc3BvbnNlEiEKDGJsb2NrX2hlaWdodBgBIAEoDVILYmxvY2tIZWlnaHQSHQoKYmxvY2tfdGltZRgCIAEoDVIJYmxvY2tUaW1lEjkKC3RyYW5zYWN0aW9uGAMgASgLMhcucGFjdHVzLlRyYW5zYWN0aW9uSW5mb1ILdHJhbnNhY3Rpb24=');
...
final $typed_data.Uint8List calculateFeeRequestDescriptor = $convert.base64Decode(
    'ChNDYWxjdWxhdGVGZWVSZXF1ZXN0EhYKBmFtb3VudBgBIAEoA1IGYW1vdW50EjYKDHBheWxvYWRfdHlwZRgCIAEoDjITLnBhY3R1cy5QYXlsb2FkVHlwZVILcGF5bG9hZFR5cGUSIQoMZml4ZWRfYW1vdW50GAMgASgIUgtmaXhlZEFtb3VudA==');
...
final $typed_data.Uint8List calculateFeeResponseDescriptor = $convert.base64Decode(
    'ChRDYWxjdWxhdGVGZWVSZXNwb25zZRIWCgZhbW91bnQYASABKANSBmFtb3VudBIQCgNmZWUYAiABKANSA2ZlZQ==');
...
final $typed_data.Uint8List broadcastTransactionRequestDescriptor =
    $convert.base64Decode(
        'ChtCcm9hZGNhc3RUcmFuc2FjdGlvblJlcXVlc3QSNAoWc2lnbmVkX3Jhd190cmFuc2FjdGlvbhgBIAEoCVIUc2lnbmVkUmF3VHJhbnNhY3Rpb24=');
...
final $typed_data.Uint8List getRawTransferTransactionRequestDescriptor =
    $convert.base64Decode(
        'CiBHZXRSYXdUcmFuc2ZlclRyYW5zYWN0aW9uUmVxdWVzdBIbCglsb2NrX3RpbWUYASABKA1SCGxvY2tUaW1lEhYKBnNlbmRlchgCIAEoCVIGc2VuZGVyEhoKCHJlY2VpdmVyGAMgASgJUghyZWNlaXZlchIWCgZhbW91bnQYBCABKANSBmFtb3VudBIQCgNmZWUYBSABKANSA2ZlZRISCgRtZW1vGAYgASgJUgRtZW1v');
...
final $typed_data.Uint8List getRawBondTransactionRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List getRawUnbondTransactionRequestDescriptor =
    $convert.base64Decode(
        'Ch5HZXRSYXdVbmJvbmRUcmFuc2FjdGlvblJlcXVlc3QSGwoJbG9ja190aW1lGAEgASgNUghsb2NrVGltZRIrChF2YWxpZGF0b3JfYWRkcmVzcxgDIAEoCVIQdmFsaWRhdG9yQWRkcmVzcxISCgRtZW1vGAQgASgJUgRtZW1v');
...
final $typed_data.Uint8List getRawWithdrawTransactionRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List getRawTransactionResponseDescriptor =
    $convert.base64Decode(
        'ChlHZXRSYXdUcmFuc2FjdGlvblJlc3BvbnNlEicKD3Jhd190cmFuc2FjdGlvbhgBIAEoCVIOcmF3VHJhbnNhY3Rpb24SDgoCaWQYAiABKAlSAmlk');
...
final $typed_data.Uint8List payloadTransferDescriptor = $convert.base64Decode(
    'Cg9QYXlsb2FkVHJhbnNmZXISFgoGc2VuZGVyGAEgASgJUgZzZW5kZXISGgoIcmVjZWl2ZXIYAiABKAlSCHJlY2VpdmVyEhYKBmFtb3VudBgDIAEoA1IGYW1vdW50');
...
final $typed_data.Uint8List payloadBondDescriptor = $convert.base64Decode(
    'CgtQYXlsb2FkQm9uZBIWCgZzZW5kZXIYASABKAlSBnNlbmRlchIaCghyZWNlaXZlchgCIAEoCVIIcmVjZWl2ZXISFAoFc3Rha2UYAyABKANSBXN0YWtlEh0KCnB1YmxpY19rZXkYBCABKAlSCXB1YmxpY0tleQ==');
...
final $typed_data.Uint8List payloadSortitionDescriptor = $convert.base64Decode(
    'ChBQYXlsb2FkU29ydGl0aW9uEhgKB2FkZHJlc3MYASABKAlSB2FkZHJlc3MSFAoFcHJvb2YYAiABKAlSBXByb29m');
...
final $typed_data.Uint8List payloadWithdrawDescriptor = $convert.base64Decode(
    'Cg9QYXlsb2FkV2l0aGRyYXcSKwoRdmFsaWRhdG9yX2FkZHJlc3MYASABKAlSEHZhbGlkYXRvckFkZHJlc3MSJwoPYWNjb3VudF9hZGRyZXNzGAIgASgJUg5hY2NvdW50QWRkcmVzcxIWCgZhbW91bnQYAyABKANSBmFtb3VudA==');
...
final $typed_data.Uint8List transactionInfoDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List decodeRawTransactionRequestDescriptor =
    $convert.base64Decode(
        'ChtEZWNvZGVSYXdUcmFuc2FjdGlvblJlcXVlc3QSJwoPcmF3X3RyYW5zYWN0aW9uGAEgASgJUg5yYXdUcmFuc2FjdGlvbg==');
...
final $typed_data.Uint8List decodeRawTransactionResponseDescriptor =
    $convert.base64Decode(
        'ChxEZWNvZGVSYXdUcmFuc2FjdGlvblJlc3BvbnNlEjkKC3RyYW5zYWN0aW9uGAEgASgLMhcucGFjdHVzLlRyYW5zYWN0aW9uSW5mb1ILdHJhbnNhY3Rpb24=');
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
    TransactionServiceBase$messageJson = const {
...
final $typed_data.Uint8List transactionServiceDescriptor = $convert.base64Decode(
    '');
