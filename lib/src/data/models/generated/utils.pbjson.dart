...
final $typed_data.Uint8List signMessageWithPrivateKeyRequestDescriptor =
    $convert.base64Decode(
        'CiBTaWduTWVzc2FnZVdpdGhQcml2YXRlS2V5UmVxdWVzdBIfCgtwcml2YXRlX2tleRgBIAEoCVIKcHJpdmF0ZUtleRIYCgdtZXNzYWdlGAIgASgJUgdtZXNzYWdl');
...
final $typed_data.Uint8List signMessageWithPrivateKeyResponseDescriptor =
    $convert.base64Decode(
        'CiFTaWduTWVzc2FnZVdpdGhQcml2YXRlS2V5UmVzcG9uc2USHAoJc2lnbmF0dXJlGAEgASgJUglzaWduYXR1cmU=');
...
final $typed_data.Uint8List verifyMessageRequestDescriptor = $convert.base64Decode(
    'ChRWZXJpZnlNZXNzYWdlUmVxdWVzdBIYCgdtZXNzYWdlGAEgASgJUgdtZXNzYWdlEhwKCXNpZ25hdHVyZRgCIAEoCVIJc2lnbmF0dXJlEh0KCnB1YmxpY19rZXkYAyABKAlSCXB1YmxpY0tleQ==');
...
final $typed_data.Uint8List bLSPublicKeyAggregationRequestDescriptor =
    $convert.base64Decode(
        'Ch5CTFNQdWJsaWNLZXlBZ2dyZWdhdGlvblJlcXVlc3QSHwoLcHVibGljX2tleXMYASADKAlSCnB1YmxpY0tleXM=');
...
final $typed_data.Uint8List bLSPublicKeyAggregationResponseDescriptor =
    $convert.base64Decode(
        'Ch9CTFNQdWJsaWNLZXlBZ2dyZWdhdGlvblJlc3BvbnNlEh0KCnB1YmxpY19rZXkYASABKAlSCXB1YmxpY0tleRIYCgdhZGRyZXNzGAIgASgJUgdhZGRyZXNz');
...
final $typed_data.Uint8List bLSSignatureAggregationRequestDescriptor =
    $convert.base64Decode(
        'Ch5CTFNTaWduYXR1cmVBZ2dyZWdhdGlvblJlcXVlc3QSHgoKc2lnbmF0dXJlcxgBIAMoCVIKc2lnbmF0dXJlcw==');
...
final $typed_data.Uint8List bLSSignatureAggregationResponseDescriptor =
    $convert.base64Decode(
        'Ch9CTFNTaWduYXR1cmVBZ2dyZWdhdGlvblJlc3BvbnNlEhwKCXNpZ25hdHVyZRgBIAEoCVIJc2lnbmF0dXJl');
const $core.Map<$core.String, $core.dynamic> UtilsServiceBase$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'BLSPublicKeyAggregation',
      '2': '.pactus.BLSPublicKeyAggregationRequest',
      '3': '.pactus.BLSPublicKeyAggregationResponse'
    },
    const {
      '1': 'BLSSignatureAggregation',
      '2': '.pactus.BLSSignatureAggregationRequest',
      '3': '.pactus.BLSSignatureAggregationResponse'
    },
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
    UtilsServiceBase$messageJson = const {
  ...
  '.pactus.BLSSignatureAggregationResponse':
      BLSSignatureAggregationResponse$json,
};
...
final $typed_data.Uint8List utilsServiceDescriptor = $convert.base64Decode(
    '');
