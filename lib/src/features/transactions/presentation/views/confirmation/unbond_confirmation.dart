...
class UnBondConfirmation extends StatelessWidget {
  const UnBondConfirmation({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        TransactionRowItem(
          title: context.tr(LocaleKeys.memo),
          value: '${data.state.memo}',
        ),
        TransactionRowItem(title: 'Signed Transaction Data', value: 'Unknown'),
      ],
    );
  }
}
