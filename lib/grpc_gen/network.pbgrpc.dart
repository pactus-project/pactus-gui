...
class NetworkClient extends $grpc.Client {
  static final _$getNetworkInfo = $grpc.ClientMethod<$0.GetNetworkInfoRequest, $0.GetNetworkInfoResponse>(
      '/pactus.Network/GetNetworkInfo',
      ($0.GetNetworkInfoRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GetNetworkInfoResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.GetNetworkInfoResponse> getNetworkInfo($0.GetNetworkInfoRequest request, {$grpc.CallOptions? options}) {
...
abstract class NetworkServiceBase extends $grpc.Service {
  ...
  NetworkServiceBase() {
    $addMethod($grpc.ServiceMethod<$0.GetNetworkInfoRequest, $0.GetNetworkInfoResponse>(
        'GetNetworkInfo',
        getNetworkInfo_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetNetworkInfoRequest.fromBuffer(value),
  ...
  $async.Future<$0.GetNetworkInfoResponse> getNetworkInfo_Pre($grpc.ServiceCall call, $async.Future<$0.GetNetworkInfoRequest> request) async {
  ...
  $async.Future<$0.GetNetworkInfoResponse> getNetworkInfo($grpc.ServiceCall call, $0.GetNetworkInfoRequest request);
