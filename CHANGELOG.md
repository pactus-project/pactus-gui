...
- [Feat]: Implement base structure, logic, and UI for the seed confirmation screen. [#77](https://github.com/pactus-project/pactus-gui/pull/82)
  - Added `ConfirmationSeedScreen` with logic to validate user-entered seed phrases.
  - Implemented UI based on Fluent design principles.
  - Integrated with wallet recovery flow.

- [Update]: Improve UI of `ChipTextBox` in the seed confirmation screen. [#77](https://github.com/pactus-project/pactus-gui/pull/82)
  - Refined `ChipTextBox` design for better user experience.
  - Adjusted colors and spacing for consistency with the rest of the UI.

- [Fix]: Resolve conflicts and merge updates. [#77](https://github.com/pactus-project/pactus-gui/pull/82)
  - Fixed merge conflicts in recent updates.
  - Ensured compatibility with latest UI and logic changes.
