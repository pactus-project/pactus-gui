...
### [Feature]
- Implemented a custom app bar for consistent navigation and styling across the entire app. [#42](https://github.com/pactus-project/pactus-gui/pull/43)

### [Refactor]
- Updated tint color for the switch button to improve visual consistency. [#132](https://github.com/pactus-project/pactus-gui/pull/132)
- Enabled accent color selection visibility in developer mode for easier theme testing. [#133](https://github.com/pactus-project/pactus-gui/pull/133)
